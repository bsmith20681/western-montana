var slideLink = [];
slideLink[1] = '/atterbury-Collection-34286';
slideLink[2] = '/weston-Collection-306467';
slideLink[3] = '/malibu-Collection-306469';
slideLink[4] = '/marco-Collection-350744';
slideLink[5] = '/presilla-Collection-351116';

slideNum = 5; // Specify the number of slides
...
function divSlideOpacity()
{
	if (currentOpacity1 == 10)
	{
		...
		'<a href="'+ slideLink[nextSlide] +'"><div id="slideLinkBox">' +
			'<img id="slideBox1" class="slide" src="/lighting-data/homepage_images/slide_images/minka-lavery-slide.jpg" />' +
			'<img id="slideBox2" class="slide" src="/lighting-data/homepage_images/slide_images/slide1.jpg" />' +
			'<img id="slideBox3" class="slide" src="/lighting-data/homepage_images/slide_images/slide2.jpg" />' +
			'<img id="slideBox4" class="slide" src="/lighting-data/homepage_images/slide_images/slide3.jpg" />' +
			'<img id="slideBox5" class="slide" src="/lighting-data/homepage_images/slide_images/slide4.jpg" />' +
		'</div></a>';
		currentOpacity1 = 100
		currentOpacity2 = 0;
